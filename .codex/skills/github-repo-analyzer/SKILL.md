...
4. **Write the report**
   ...
   - Append one summary row to `reports/SUMMARY.csv` (columns: `repo,url,stars,language,direction,key_features,architecture,highlights,report`). For batch runs, regenerate SUMMARY.csv at the end from all reports.
